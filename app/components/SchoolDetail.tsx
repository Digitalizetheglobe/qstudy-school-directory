...
export default function SchoolDetail({ onApplyNowClick: _onApplyNowClick }: SchoolDetailProps) {
  ...
  return (
    <section id="school-detail" style={{ padding: '100px 24px', background: 'var(--surface)' }}>
          ...
          {tabs.map(tab => (
            <button
              ...
              style={{
                ...
                background: active === tab.id ? 'linear-gradient(135deg,#4F46E5,#06B6D4)' : 'transparent',
