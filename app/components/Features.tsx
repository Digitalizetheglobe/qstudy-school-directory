...
const cards = [
  {
    ...
    desc: 'Discover thousands of schools across 120+ countries - all in one place.',
    accent: '#4F46E5',
  ...
  },
  {
    ...
    desc: 'Connect with peers and expert advisors for personalized guidance and support.',
    accent: '#F59E0B',
